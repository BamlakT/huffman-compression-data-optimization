...
(treeComp, alignTree) = tobinary("00010110110100101110011101101001101110101101100001010010000000101101110101100110101101000")
...
print(decompress(dataComp, align, treeComp, alignTree)=='um ah human huffman is fun i am a fan ha ha ha ha ha ha')
